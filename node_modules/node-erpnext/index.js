...
ERPNext.prototype.getTablesName = function(){
    var _this = this;
    return _this.login().then(function (res) {
        return requestPromise.get({
            url: _this.baseUrl + "/api/resource/Dine-in-tables",
            jar: _this.cookieJar,
...
ERPNext.prototype.getTablesByName = function(name){
    var _this = this;
    return _this.login().then(function (res) {
        return requestPromise.get({
            url: _this.baseUrl + "/api/resource/Dine-in-tables/"+ name,
            jar: _this.cookieJar,
        }).then(function (tables) {
            tables = JSON.parse(tables);
            return tables.data;
...
ERPNext.prototype.getTables = function(){
    var _this = this;
    return _this.getTablesName().then(function (name) {
        return Promise.map(name, function (table) {
            return _this.getTablesByName(table.name);
        });
    })
}
